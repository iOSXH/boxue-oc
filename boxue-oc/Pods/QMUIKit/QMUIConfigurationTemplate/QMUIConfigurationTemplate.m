...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarButtonFont = UIFontMake(18);                                             // NavBarButtonFont : QMUINavigationButtonTypeNormal 和 UINavigationBar 上的 UIBarButtonItem 的字体
    ...
    QMUICMI.tableViewGroupedBackgroundColor = UIColorWhite;                              // TableViewGroupedBackgroundColor : Grouped 类型的 QMUITableView 的背景色
